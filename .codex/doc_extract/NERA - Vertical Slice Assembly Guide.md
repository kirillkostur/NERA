...
- выключение Computer закрывает терминал;
...
- Solar Panel, Battery и Computer имеют специальное управление и не должны превращаться в обычные controllable-объекты без проверки логики.
