...
prefab, location configs, quest catalog и PC quality assets. Он пока не
проверяет station upgrade graph, scene-object persistence, health/death UX,
audio, authored route, current build и full-flow completion.
