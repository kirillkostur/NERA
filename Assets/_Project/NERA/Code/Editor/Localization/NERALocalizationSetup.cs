    ...
    public static class NERALocalizationSetup
    {
        ...
        private static readonly Dictionary<string, string> StaticRussian =
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Generates station power."] = "Вырабатывает энергию станции.",
        ...
        private static readonly Dictionary<string, string> ContentRussian =
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["item.item_antenna_array_01.name"] = "Антенная решётка",
                ["item.item_antenna_array_01.description"] = "Расширяет зону приёма антенны и дальность сканирования сигналов.",
                ["item.item_calibration_module_01.name"] = "Модуль калибровки",
                ["item.item_calibration_module_01.description"] = "Ускоряет калибровку антенны и увеличивает дальность сканирования.",
                ["item.item_signal_amplifier_01.name"] = "Усилитель сигнала",
                ["item.item_signal_amplifier_01.description"] = "Усиливает слабые сигналы и сокращает время калибровки.",
                ["item.item_signal_processor_01.name"] = "Сигнальный процессор",
                ["item.item_signal_processor_01.description"] = "Обрабатывает сигналы, расширяя область сканирования и ускоряя калибровку.",
                ["item.item_cooling_system_01.name"] = "Система охлаждения",
                ["item.item_cooling_system_01.description"] = "Отводит тепло от батареи при высокой нагрузке.",
                ["item.item_energy_cells_01.name"] = "Энергетические ячейки",
                ["item.item_energy_cells_01.description"] = "Хранят основной запас энергии станции.",
                ["item.item_power_bus_01.name"] = "Силовые шины",
                ["item.item_power_bus_01.description"] = "Передают энергию батареи системам станции.",
                ["item.item_power_controller_01.name"] = "Силовой контроллер",
                ["item.item_power_controller_01.description"] = "Управляет резервным питанием и выходной мощностью.",
                ["item.item_power_converter_01.name"] = "Преобразователь энергии",
                ["item.item_power_converter_01.description"] = "Сохраняет преобразованную энергию в резерве батареи.",
                ["item.item_voltage_regulator_01.name"] = "Стабилизатор напряжения",
                ["item.item_voltage_regulator_01.description"] = "Стабилизирует напряжение батареи при пиковой нагрузке.",
                ["station.battery.station_battery.description"] = "Накапливает выработанную энергию.",
                ["item.item_solar_cells_01.name"] = "Фотоэлектрические элементы",
                ["item.item_solar_cells_01.description"] = "Высокоэффективные фотоэлектрические элементы увеличивают выходную мощность панели.",
                ["item.item_solar_dust_repeller_01.name"] = "Пылезащита",
                ["item.item_solar_dust_repeller_01.description"] = "Электростатическое поле сохраняет производительность панели даже под слоем пыли.",
                ["item.item_solar_mppt_controller_01.name"] = "Оптимизатор мощности",
                ["item.item_solar_mppt_controller_01.description"] = "Поддерживает панель в точке максимальной мощности при изменении условий.",
                ["item.item_solar_tracker_01.name"] = "Привод слежения",
                ["item.item_solar_tracker_01.description"] = "Отслеживает положение солнца и повышает выработку панели в течение дня.",
                ["item.item_advanced_stabilizer_01.name"] = "Улучшенный стабилизатор",
                ["item.item_advanced_stabilizer_01.description"] = "Стабилизирует дрон в полёте и увеличивает дальность перемещения.",
                ["item.item_capacitor_01.name"] = "Конденсатор",
                ["item.item_capacitor_01.description"] = "Накапливает энергию для систем дрона во время полёта.",
                ["item.item_power_core_01.name"] = "Силовое ядро",
                ["item.item_power_core_01.description"] = "Увеличивает ёмкость батареи и дальность полёта дрона.",
                ["item.item_propulsion_01.name"] = "Двигательная установка",
                ["item.item_propulsion_01.description"] = "Создаёт тягу и увеличивает дальность полёта дрона.",
                ["item.item_sensor_array_01.name"] = "Сенсорный комплекс",
                ["item.item_sensor_array_01.description"] = "Улучшает навигацию дрона и сканирование на большой дистанции.",
                ["item.item_chassis_01.name"] = "Корпус",
                ["item.item_chassis_01.description"] = "Укрепляет турель и снижает получаемый урон.",
                ["item.item_cooling_01.name"] = "Система охлаждения",
                ["item.item_cooling_01.description"] = "Отводит тепло для более скоростной непрерывной стрельбы.",
                ["item.item_emitter_damage_01.name"] = "Эмиттер урона",
                ["item.item_emitter_damage_01.description"] = "Увеличивает урон каждого выстрела турели.",
                ["item.item_sensor_01.name"] = "Датчик",
                ["item.item_sensor_01.description"] = "Увеличивает дальность обнаружения целей турелью.",
                ["item.item_servo_01.name"] = "Сервомеханизм",
